ActiveAdmin.setup do |config|
  ...
  #
  config.site_title = "Forensik Analysis Network"
  ...
  config.register_javascript 'rails.js'
  config.register_javascript 'graph/highcharts.js'
  config.register_javascript '/javascript/change_log_files.js'
end
